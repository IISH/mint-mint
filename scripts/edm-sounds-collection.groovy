...
// Bookmarks
////////////////////
mappings.addBookmarkForXpath("Title", "/RDF/Collection/title");
mappings.addBookmarkForXpath("Description", "/RDF/Collection/description");
mappings.addBookmarkForXpath("Subject", "/RDF/Collection/subject");
mappings.addBookmarkForXpath("Creator", "/RDF/Collection/creator");
mappings.addBookmarkForXpath("Identifier", "/RDF/Collection/identifier");
