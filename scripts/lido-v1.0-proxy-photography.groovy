...
//handlers = template.find("//lido:eventDescriptionSet/lido:descriptiveNoteID")
//for(Element conceptID: handlers) {
//    conceptID.setThesaurus(MappingPrimitives.thesaurus("http://bib.arts.kuleuven.be/photoVocabulary/Subject"));
//}
eventPractice.setThesaurus(MappingPrimitives.thesaurus("http://bib.arts.kuleuven.be/photoVocabulary/Photographic_practice"));
