...
<%if(user.hasRight(User.SUPER_USER)){%>
    ...
    <!-- Adding checkbox for only root to login -->
	<div title="Root actions" data-load='{"kConnector":"html.page", "url":"Management.action?uaction=accessibility", "kTitle":"Accessibility" }' class="items navigable">
