...
public class Dataset implements Lockable, SecurityEnabled {
	...
	public boolean isPublishing() {
		...
		else if (status.equals(PUBLICATION_RUNNING)) return true;
		return false;
	}
	 ...
	 * attached schema. If the paths in the schema don't yield 
	 ...
	 * If a derived transformation has an AnnotatedDataset, then only the latter will
	...
	/**
	 * Remove associated data/items, deletes derived datasets from db,
	 * all derived items from index and enable the re-use of the Dataset.
	 * 
	 * 
	 */
	public void clean() {
